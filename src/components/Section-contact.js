        ...
        <div className="wrap">
          ...
          <div className="text-center">
            ...
            <div className="social">
              <a href="http://github.com/tjdunklee" className="social__item" target="_blank" rel="noopener">
              ...
              <a href="http://www.facebook.com/tdunklee" className="social__item" target="_blank" rel="noopener">
              ...
              <a href="http://instagram.com/tjdunklee" className="social__item" target="_blank" rel="noopener">
              ...
              <a href="http://www.flickr.com/timdunklee" className="social__item" target="_blank" rel="noopener">
