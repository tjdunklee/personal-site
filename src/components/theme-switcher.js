...
class ThemeSwitcher extends React.Component {
  render() {
    return (
      <React.Fragment>
        <button className="theme-switcher" onClick={this.props.toggleDarkMode}>
          <svg className="theme-icon theme-icon--sun" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
          ...
          <svg className="theme-icon theme-icon--winter" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
            <title>Turn Off Dark Mode</title>
        ...
        <span aria-live="polite" className="visuallyhidden">{ this.props.darkMode ? 'Dark mode is now active' : 'Dark mode is now disabled' }</span>
      </React.Fragment>
    )
  }
}
